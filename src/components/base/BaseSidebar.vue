                ...
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                          ...
                          <a
                            ...
                            :class="[
                              item.current
                                ...
                                : 'text-indigo-200 hover:bg-green-700 hover:text-white',
                    ...
                    <li>
                      ...
                      <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li v-for="team in teams" :key="team.name">
                          ...
                          >
                            <span
                              class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-green-400 bg-green-500 text-[0.625rem] font-medium text-white"
                              >{{ team.initial }}</span
                            >
                    ...
                    <li class="mt-auto">
                      <a
                        href="#"
                        class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-green-200 hover:bg-green-700 hover:text-white"
                      >
                        <Cog6ToothIcon
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li class="mt-auto">
              ...
              >
                <Cog6ToothIcon
                  class="size-6 shrink-0 text-green-200 group-hover:text-white"
                  aria-hidden="true"
                />
                Settings
              </a>
